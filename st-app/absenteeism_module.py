...
class absenteeism_model():
        ...
        def __init__(self, model_file, scaler_file):
            ...
            scaler_file = os.path.join(path,'scaler')
...
###################################################################################       
       ...
       'Education', 'Children', 'Pets', 'Absenteeism Time in Hours',
            ...
            reordered_columns = ['Reason1','Reason2','Reason3','Reason4','Date', 'Transportation Expense', 'Distance to Work', 'Age','Daily Work Load Average(in Minutes) ', 'Body Mass Index',
       'Education', 'Children', 'Pets', 'Absenteeism Time in Hours']
       ...
       'Daily Work Load Average(in Minutes) ', 'Body Mass Index', 'Education', 'Children', 'Pets', 'Absenteeism Time in Hours']
            ...
            df = df.drop(['Day of the Week','Daily Work Load Average(in Minutes) ','Distance to Work'],axis=1)
